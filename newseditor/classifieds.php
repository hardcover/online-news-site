...
foreach ($stmt as $row) {
    ...
    if ($i == 1) {
        ...
        echo '    <p><input type="submit" value="Publish" name="publish" class="left" /><input type="submit" value="Delete" name="delete" class="right" /><input name="idAd" type="hidden" value="' . $idAd . '" /></p>' . "\n";
        echo "  </form>\n\n";
    }
}
$dbh = null;
