...
?>
  ...
  <h4 class="m"><a class="m" href="usersEditors.php">&nbsp;Editing users&nbsp;</a><a class="s" href="usersSubscribers.php">&nbsp;Patron mgt users&nbsp;</a></h4>
...
<?php echoIfMessage($message); ?>
  ...
  <h1><span class="h">Subscriber management users</span></h1>
