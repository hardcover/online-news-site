    ...
    if (isset($_POST['addUpdate'])) {
        ...
        if ($_POST['user'] != null) {
            ...
            if (is_null($hash)) {
                ...
                $stmt->execute(array($userPost, $fullNamePost, 4, $idUser));
            } else {
                $stmt = $dbh->prepare('UPDATE users SET user=?, pass=?, fullName=?, userType=? WHERE idUser=?');
                $stmt->execute(array($userPost, $hash, $fullNamePost, 4, $idUser));
            }
            $dbh = null;
        } else {
            if (is_null($message)) {
...
?>
  ...
  <h4 class="m"><a class="m" href="usersAdvertising.php">&nbsp;Advertising users&nbsp;</a><a class="s" href="usersClassified.php">&nbsp;Classified users&nbsp;</a></h4>

  <h4 class="m"><a class="m" href="menu.php">&nbsp;Menu&nbsp;</a><a class="m" href="settings.php">&nbsp;Settings&nbsp;</a><a class="m" href="classifiedSections.php">&nbsp;Classifieds&nbsp;</a></h4>
<?php echoIfMessage($message); ?>

  <h1 id="waiting">Please wait.</h1>

  <h1><span class="h">Classifieds users</span></h1>
