...
?>
    ...
    <p><input type="submit" value="Add / update" name="addUpdate" class="left" /><input type="submit" value="Delete photos" name="deletePhoto" class="right" /><input type="hidden" name="existing"<?php echoIfValue($edit); ?> /></p>
  </form>
