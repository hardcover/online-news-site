...
<?php require $includesPath . '/editor/body.inc';?>
  ...
  <nav class="n">
    <h4 class="m"><a class="s" href="advertisingPublished.php">Published ads</a><a class="m" href="advertisingEdit.php">Edit ads</a><a class="m" href="advertisingMax.php">Settings</a></h4>
  </nav>
